...
/// Manages App Store nominations — submitting an app for editorial featuring on the
/// App Store (app launch, app enhancements, or new content).
public final class NominationsWorker: Sendable {
    ...
    /// Get list of available nomination tools.
