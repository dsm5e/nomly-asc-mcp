        ...
        Tool(
            ...
            inputSchema: .object([
                ...
                "properties": .object([
                    ...
                    "next_url": .object([
                        "type": .string("string"),
                        "description": .string("Pagination URL from a previous response")
                    ])
                ]),
                "required": .array([])
            ])
    ...
    func createNominationTool() -> Tool {
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "name": .object(["type": .string("string"), "description": .string("Internal name for the nomination")]),
                    "nomination_type": .object(["type": .string("string"), "description": .string("Type: APP_LAUNCH (new app), APP_ENHANCEMENTS (significant update), or NEW_CONTENT")]),
                    "description": .object(["type": .string("string"), "description": .string("Pitch description for Apple's editorial team — what's new and why it should be featured")]),
                    "publish_start_date": .object(["type": .string("string"), "description": .string("Desired publish start date (ISO 8601, e.g. 2026-07-01T00:00:00Z)")]),
                    "related_app_ids": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("App IDs this nomination relates to (at least one required)")]),
                    "submitted": .object(["type": .string("boolean"), "description": .string("true = submit now, false = save as draft (default false)")]),
                    "publish_end_date": .object(["type": .string("string"), "description": .string("Optional desired publish end date (ISO 8601)")]),
                    "device_families": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("Optional device families: IPHONE, IPAD, APPLE_TV, APPLE_WATCH, MAC, VISION")]),
                    "locales": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("Optional locale codes the nomination targets (e.g. en-US)")]),
                    "supplemental_materials_uris": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("Optional URLs to supplemental materials (videos, press kit)")]),
                    "has_in_app_events": .object(["type": .string("boolean"), "description": .string("Optional — nomination involves in-app events")]),
                    "launch_in_select_markets_first": .object(["type": .string("boolean"), "description": .string("Optional — staged market launch")]),
                    "notes": .object(["type": .string("string"), "description": .string("Optional additional notes for Apple")]),
                    "pre_order_enabled": .object(["type": .string("boolean"), "description": .string("Optional — app is available for pre-order")]),
                    "in_app_event_ids": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("Optional related in-app event IDs")]),
                    "territory_ids": .object(["type": .string("array"), "items": .object(["type": .string("string")]), "description": .string("Optional supported territory IDs (e.g. USA, GBR)")])
                ]),
                "required": .array([
    ...
    func updateNominationTool() -> Tool {
        Tool(
            ...
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "nomination_id": .object(["type": .string("string"), "description": .string("Nomination ID")]),
